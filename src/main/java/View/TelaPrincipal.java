...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setMaximumSize(new java.awt.Dimension(151, 86));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextField11, javax.swing.GroupLayout.DEFAULT_SIZE, 322, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jLabel21.setText("Consultas do tratamento selecionado");
        ...
        jButton8.setText("Remover consulta");
        ...
        jLabel8.setText("Selecione a tabela antes de realizar qualquer operação");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jLabel21, javax.swing.GroupLayout.PREFERRED_SIZE, 755, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jScrollPane5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 767, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(109, 109, 109)
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Data de Início", "Data de Fim", "Descrição"
            }
        ));
        ...
        jTabbedPane1.addTab("Gerenciar Tratamentos e Consultas", jPanel5);
    ...
    private void jTextField11MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTextField11MousePressed
        ...
        jTextField11.setText(veterinarioLista.getValorSelecionado());
        
    }//GEN-LAST:event_jTextField11MousePressed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Controller.Controller.removerCliente(Controller.Controller.getClienteSelecionado());
        ((ClienteTableModel) jTable1.getModel()).removeItem(jTable1.getSelectedRow());
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Controller.Controller.removerAnimal(Controller.Controller.getAnimalSelecionado());
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ((TratamentoTableModel) jTable4.getModel()).addItem(Controller.Controller.adicionaTratamento("", "", "", "", Controller.Controller.getAnimalSelecionado().getId(), false));
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ((DetalhesTratTableModel) jTable5.getModel()).addItem(Controller.Controller.adicionaConsulta("", "", Controller.Controller.getAnimalSelecionado().getId(), 1, Controller.Controller.getTratamentoSelecionado().getId()));
